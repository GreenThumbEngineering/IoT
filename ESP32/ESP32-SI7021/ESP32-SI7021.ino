...
//Set Raspberrypi connection settings from GreenthumbIoTConfig.h
String WifiName;
String Password;
String Host;
uint16_t Port;
...
void setup() {
    ...
    delay(10); //si7021 requires 2ms to start up. 
...
void loop() {
    ...
    if(WiFi.isConnected()) {
        ...
        if(client.connect(Host.c_str(),Port)){ 
            ...
            float temp = atmosphericSensor.getTemp();
            float hum = atmosphericSensor.getRH();
